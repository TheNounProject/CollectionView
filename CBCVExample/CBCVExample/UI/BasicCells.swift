...
final class BasicHeaderView : CBCollectionReusableView {
    
    let titleLabel = NSTextField(frame: CGRect.zero)
    let accessoryButton = CBIconButton(frame: CGRect.zero)
    ...
    class func register(_ collectionView: CBCollectionView) {
        collectionView.registerClass(BasicHeaderView.self, forSupplementaryViewOfKind: CBCollectionViewLayoutElementKind.SectionHeader, withReuseIdentifier: "BasicHeaderView")
    }
