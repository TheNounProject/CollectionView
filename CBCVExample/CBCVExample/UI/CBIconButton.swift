...
@IBDesignable open class CBIconButton : CBButton {
    
    private let iconLayer = CBIconLayer()
    ...
    open var iconType: CBIconType { get { return iconLayer.iconType }}
     ...
     */
    open func setIcon(_ type: CBIconType, animated: Bool) {
...
open class CBIconLayer : CALayer {
    ...
    /// The icon currently displayed in the button (read only)
    open var iconType: CBIconType { get { return _type }}
    
    fileprivate var _type : CBIconType! = .hamburger
...
class CBButtonCell : NSButtonCell {
...
@IBDesignable open class CBButton : NSButton {
