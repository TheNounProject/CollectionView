...
class ViewController: NSViewController, ResultsControllerDelegate, CBCollectionViewDelegate, CBCollectionViewDataSource, BasicHeaderDelegate{
    ...
    func collectionView(_ collectionView: CBCollectionView, viewForSupplementaryElementOfKind kind: String, forIndexPath indexPath: IndexPath) -> CBCollectionReusableView {
    ...
    func basicHeaderView(_ view: BasicHeaderView, didSelectButton button: CBIconButton) {
