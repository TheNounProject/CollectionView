...
public final class CBCollectionViewGridLayout : CBCollectionViewLayout {
    ...
    fileprivate weak var delegate : CBCollectionViewDelegateGridLayout? { get{ return self.collectionView!.delegate as? CBCollectionViewDelegateGridLayout }}
    ...
    fileprivate var sectionRowAttributes : [Int:[[CBCollectionViewLayoutAttributes]]] = [:]
    ...
    override public func prepareLayout(){
        ...
        for section in 0..<numberOfSections {
            ...
            if heightHeader > 0 {
                let attributes = CBCollectionViewLayoutAttributes(forSupplementaryViewOfKind: CBCollectionViewLayoutElementKind.SectionHeader, withIndexPath: IndexPath.for(item:0, section: section))
                attributes.alpha = 1
...
//            let footerHeight = self.delegate?.collectionView?(self.collectionView!, layout: self, heightForFooterInSection: section) ?? self.footerHeight
//            if footerHeight > 0 {
//                let attributes = CBCollectionViewLayoutAttributes(forSupplementaryViewOfKind: CBCollectionViewLayoutElementKind.SectionFooter, withIndexPath: NSIndexPath.for(item:0, section: section))
//                attributes.alpha = 1
//                attributes.frame = insetSupplementaryViews ?
