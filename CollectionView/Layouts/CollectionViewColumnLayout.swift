...
public protocol CollectionViewDelegateColumnLayout {
    ...
    func collectionView(_ collectionView: CollectionView, layout collectionViewLayout: CollectionViewColumnLayout,
...
open class CollectionViewColumnLayout: CollectionViewLayout {
    ...
    private var delegate: CollectionViewDelegateColumnLayout? { return self.collectionView!.delegate as? CollectionViewDelegateColumnLayout }
    ...
    open func prepare() {
        ...
        self.leadingViewAttributes =  nil
