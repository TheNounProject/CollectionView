...
public protocol CollectionViewLayout: AnyObject {
    ...
    var scrollDirection: CollectionViewScrollDirection { get }
...
//    }
    ...
    var allIndexPaths: OrderedSet<IndexPath> { get set }
    ...
    /// Returns index paths for items in a given rect
    ...
    ///
    /// - Parameter rect: The rect in which to look for elements
    func layoutAttributesForItems(in rect: CGRect) -> [CollectionViewLayoutAttributes]
    ...
    func layoutAttributesForItem(at indexPath: IndexPath) -> CollectionViewLayoutAttributes?
    ...
    func layoutAttributesForSupplementaryView(ofKind kind: String, at indexPath: IndexPath) -> CollectionViewLayoutAttributes?
    ...
    func contentRectForSection(_ section: Int) -> CGRect
    ...
    func scrollRectForItem(at indexPath: IndexPath, atPosition: CollectionViewScrollPosition) -> CGRect?
    ...
    func indexPathForNextItem(moving direction: CollectionViewDirection, from currentIndexPath: IndexPath) -> IndexPath?
}
...
extension CollectionViewLayout {
    ...
    public func contentRectForSection(_ section: Int) -> CGRect {
        overrideWarning()
...
extension CollectionViewLayout {
    ...
    public func layoutAttributesForSupplementaryView(ofKind elementKind: String, atIndexPath indexPath: IndexPath) -> CollectionViewLayoutAttributes? { return nil }
