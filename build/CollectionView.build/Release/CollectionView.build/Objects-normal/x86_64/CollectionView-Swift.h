...
- (CollectionViewCell * _Nonnull)dequeueReusableCellWithReuseIdentifier:(NSString * _Nonnull)identifier for:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
- (CollectionReusableView * _Nonnull)dequeueReusableSupplementaryViewOfKind:(NSString * _Nonnull)elementKind withReuseIdentifier:(NSString * _Nonnull)identifier for:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
/// note:
/// Assigning a new layout object to this property does <em>NOT</em> apply the layout to the collection view. Call <code>reloadData()</code> or <code>reloadLayout(_:)</code> to do so.
...
/// note:
///
/// This will only be applied if the layout is also invalidated via <code>shouldInvalidateLayout(forBoundsChange:)</code>
/// <ul>
///   <li>
///     Discussion:
///     Set to <code>true</code> if the number of sections or items per section can change depending on the collection view’s size For example if you want to limit the size of a section but maintain item size, you can calculate the number of items that will fit in the section based on the size of the collection view and return that value in collectionView(_:numberOfItemsIn:) from the collection views data source.
///   </li>
/// </ul>
/// +–––––+      +—————–+
/// |          |      |                 |
...
/// <h2>Example Usage</h2>
/// If your cells require complex loading that may slow scrolling performance, <code>peakScrollVelocity</code> can be used to determine if the cell content should be reduced or delayed until after the scrolling ends.
...
///
/// \endcodeThen, in your collection view’s delegate
/// \code
...
@property (nonatomic, readonly, copy) NSArray<NSIndexPath *> * _Nonnull indexPathsForVisibleSections;
/// Returns the lowest index path of all visible items
...
/// If true, the delegate’s <code>collectionView(_:,mouseMovedToSection:)</code> will be notified when the cursor is within a section frame
...
- (BOOL)itemAtIndexPathIsSelected:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)itemAtIndexPathIsVisible:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
- (CollectionViewCell * _Nullable)cellForItemAt:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
- (NSIndexPath * _Nullable)indexPathFor:(CollectionViewCell * _Nonnull)cell SWIFT_WARN_UNUSED_RESULT;
...
/// \param point A point within the contentDocumentView’s frame
///
...
- (NSIndexPath * _Nullable)firstIndexPathForItemWithNear:(CGPoint)point radius:(CGFloat)radius SWIFT_WARN_UNUSED_RESULT;
/// Returns the first index path found intersecting a given rect
/// \param rect A rect within the contentDocumentView’s frame
///
///
/// returns:
/// The index path for the matching item or nil if no items were found
- (NSIndexPath * _Nullable)firstIndexPathForItemIn:(CGRect)rect SWIFT_WARN_UNUSED_RESULT;
...
- (NSArray<NSIndexPath *> * _Nonnull)indexPathsForItemsIn:(CGRect)rect SWIFT_WARN_UNUSED_RESULT;
...
- (NSIndexPath * _Nullable)indexPathForSectionAt:(CGPoint)point SWIFT_WARN_UNUSED_RESULT;
/// Returns all visible cells in the collection view
...
- (NSIndexPath * _Nullable)indexPathForSupplementaryView:(CollectionReusableView * _Nonnull)view SWIFT_WARN_UNUSED_RESULT;
...
- (CollectionReusableView * _Nullable)supplementaryViewsForElementKind:(NSString * _Nonnull)kind at:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
/// Returns the visible supplementary view of the given kind at indexPath
/// \param kind The kind of the supplementary view
///
/// \param indexPath The index path of the supplementary view
...
/// returns:
/// The view of kind at the given index path
- (CollectionReusableView * _Nullable)supplementaryViewForElementKind:(NSString * _Nonnull)kind at:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)cancelScrollAnimation;
- (void)scrollToTopWithAnimated:(BOOL)animated completion:(void (^ _Nullable)(BOOL))completion;
...
/// returns:
/// A valid CollectionViewCell
+ (CollectionViewCell * _Nonnull)dequeFor:(NSIndexPath * _Nonnull)indexPath in:(CollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)prepareLayout SWIFT_UNAVAILABLE_MSG("'prepareLayout' has been renamed to 'prepare()'");
...
- (CGRect)rectForSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
- (CGRect)contentRectForSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (NSInteger)numberOfColumnsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
/// \param collectionView The asking collection view
///
/// \param indexPath The index path of the item potentially being selected
///
...
- (BOOL)collectionView:(CollectionView * _Nonnull)collectionView shouldSelectItemAt:(NSIndexPath * _Nonnull)indexPath with:(NSEvent * _Nullable)event SWIFT_WARN_UNUSED_RESULT;
/// Tells the delegate that an item has been selected
/// \param collectionView The reporting collection view
///
/// \param indexPath The index path of the item that was selected
///
...
///
/// returns:
/// True if the item should be deselected
- (BOOL)collectionView:(CollectionView * _Nonnull)collectionView shouldDeselectItemAt:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
/// Tells the delegate that an item was deselected
/// \param collectionView The reporting collection view
///
/// \param indexPath The index path of the item that was deselected
///
...
/// Because the preview collection view must share a data source with it’s source, it can be useful to keep some items displayed in the source from being previewed. See <code>collectionViewPreviewController(_:canPreviewItemAt:)</code> in CollectionViewPreviewControllerDelegate
...
- (NSInteger)numberOfSectionsIn:(CollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(CollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (BOOL)previewLayout:(CollectionViewPreviewLayout * _Nonnull)layout canPreviewItemAt:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CollectionViewCell * _Nonnull)collectionView:(CollectionView * _Nonnull)collectionView cellForItemAt:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
